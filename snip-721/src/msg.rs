...
pub struct InitMsg {
    ...
    /// list of svg server contractsm where index 0 will be set as the default svg server
...
pub enum HandleMsg {
    ...
    /// allow an admin to add a new svg server contract
    AddSvgServer {
        /// svg server contract info
        svg_server: ContractInfo,
        /// optional message length padding
        padding: Option<String>,
    },
    /// allow an admin to set a new default svg server contract
    SetDefaultSvgServer {
        /// svg server contract address
        svg_server: HumanAddr,
        /// optional message length padding
        padding: Option<String>,
    },
...
pub enum QueryMsg {
    ...
    SvgServerContracts {
        ...
        page: Option<u16>,
        /// optional limit to the number of contracts to show.  Defaults to 100 if not specified
        page_size: Option<u16>,
    },
    /// display the default svg server contract
    DefaultSvgServer {
        /// address and viewing key of the querier
        viewer: ViewerInfo,
    },
...
pub enum QueryAnswer {
    ...
    /// display the svg server contracts
    SvgServerContracts {
        /// number of svg server contracts
        count: u16,
